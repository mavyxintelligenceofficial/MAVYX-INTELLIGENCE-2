...
# later (e.g. to providers/anthropic_provider.py once there's budget)
# means changing only this one line, same principle as
# MARKET_DATA_PROVIDER in market-service.
_provider: ModelProvider = GeminiProvider()
